...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{vm.png} % Replace image_path with the path to your image
...
192.168.215.0/24 > 192.168.215.102  » [15:05:03] [sys.log] [inf] gateway monitor started ...
192.168.215.0/24 > 192.168.215.102  » net.probe on
192.168.215.0/24 > 192.168.215.102  » [15:05:10] [sys.log] [inf] net.probe starting net.recon as a requirement for net.probe
192.168.215.0/24 > 192.168.215.102  » [15:05:10] [sys.log] [inf] net.probe probing 256 addresses on 192.168.215.0/24
192.168.215.0/24 > 192.168.215.102  » [15:05:10] [endpoint.new] endpoint 192.168.215.50 detected as 08:00:27:42:0a:d3 (PCS Computer Systems GmbH).
192.168.215.0/24 > 192.168.215.102  » net.show

┌─────────────────┬───────────────────┬───────────────────┬───────────────────────────┬────────┬────────┬──────────┐
│      IP ▴       │        MAC        │       Name        │          Vendor           │  Sent  │ Recvd  │   Seen   │
├─────────────────┼───────────────────┼───────────────────┼───────────────────────────┼────────┼────────┼──────────┤
│ 192.168.215.102 │ 2c:59:e5:ba:4e:62 │ eth0              │ Hewlett Packard           │ 0 B    │ 0 B    │ 15:05:03 │
│ 192.168.215.1   │ a4:4c:c8:50:e9:1e │ gateway           │ Dell Inc.                 │ 3.7 kB │ 650 B  │ 15:05:03 │
│                 │                   │                   │                           │        │        │          │
│ 192.168.215.50  │ 08:00:27:42:0a:d3 │ ADMIN.connectify. │ PCS Computer Systems GmbH │ 4.0 kB │ 165 kB │ 15:05:13 │
└─────────────────┴───────────────────┴───────────────────┴───────────────────────────┴────────┴────────┴──────────┘
